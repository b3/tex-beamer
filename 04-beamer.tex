...
\begin{frame}[fragile]
  ...
  %%% \pause %%% FIXME: https://tex.stackexchange.com/questions/585824/pause-with-transparent-rounded-shadow-blocks-rendered-incorrectly
...
\begin{frame}[plain,fragile]
  \begin{center}
    \includegraphics[height=.9\textheight]{tux}
