...
\begin{frame}% [shrink] si on veut forcer à tenir sur une seul frame
  ...
  \begin{itemize}
  \item Cette présentation est produite par \texttt{\textbf{modele-cours-lyon.tex}}
  \item Elle est conçue pour des cours magistraux à Lyon~2 pour des gens du GATE
